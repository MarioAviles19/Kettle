...
{#if open}
    <div transition:fade class="fixed top-0 left-0 w-full h-full flex justify-center items-center z-10 bg-[#0000002d]">
        <div class="max-w-120 min-w-56 rounded-md bg-background-1 p-4 border-2 border-accent-1 mb-10">
